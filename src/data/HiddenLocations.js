...
export const HiddenLocations = [
  ...
  new Location("anglers_retreat", new LatLng(-70.6484375, 71.3125)),
  ...
  new Location("abalone_cliffs", new LatLng(-78.96875, 101.8984375)),
  ...
  new Location("brittle_isle", new LatLng(-6.96875, 46.3125)),
  new Location("buccaneers_haven", new LatLng(-26.1875, 52.9453125)),
  ...
  new Location("cape_conch", new LatLng(-89.234375, 109.1328125)),
  ...
  new Location("charred_island", new LatLng(-85.2578125, 78.8046875)),
  new Location("chinchompa_island", new LatLng(-37.2265625, 43.265625)),
  ...
  new Location("crown_jewel", new LatLng(-73.15625, 37.4375)),
  ...
  new Location("deepfin_point_dock", new LatLng(-68.671875, 46.0859375)),
  new Location("deepfin_point_mine", new LatLng(-66.515625, 46.359375)),
  new Location(
    "desert_mining_camp",
    new LatLng(-56.35652680233974, 109.07839342913171),
  ),
  new Location("digsite_hill", new LatLng(-39.9609375, 112.3515625)),
  new Location("dognose_island", new LatLng(-73.7109375, 98.140625)),
  ...
  new Location("drumstick_isle", new LatLng(-31.8046875, 55.1640625)),
  ...
  new Location("elid_delta", new LatLng(-71.2265625, 108.3359375)),
  ...
  new Location("everwinter_sea", new LatLng(-6.078125, 37.7421875)),
  ...
  new Location("freminnik_strait", new LatLng(-20.2734375, 66.0078125)),
  ...
  new Location("grandroot_bay", new LatLng(-32.3203125, 66.4921875)),
  new Location("great_conch_east_docks", new LatLng(-82.5, 107.3359375)),
  new Location("great_conch_north_trees", new LatLng(-79.7265625, 102.3046875)),
  new Location("grimstone", new LatLng(-6.6328125, 91.6875)),
  new Location("gu'tanoth", new LatLng(-56.109375, 72.9140625)),
  new Location("gwenith_glide", new LatLng(-34.671875, 55.390625)),
  ...
  new Location("isle_of_bones", new LatLng(-79, 73.78125)),
  new Location("jatizo_entrance", new LatLng(-20.0859375, 68.125)),
  new Location("jubbly_jive", new LatLng(-57.40625, 65.1484375)),
  new Location("kastori", new LatLng(-56.3203125, 18.7265625)),
  new Location("kastori_delta", new LatLng(-56.140625, 22.484375)),
  ...
  new Location("lacerta_falls", new LatLng(-35.3671875, 18.953125)),
  new Location("laguna_aurorae", new LatLng(-67.9453125, 9.0390625)),
  new Location("lands_end_fountain", new LatLng(-37.3203125, 25.4140625)),
  new Location("last_song_wreck", new LatLng(-46.46875, 47.796875)),
  ...
  new Location("little_pearl", new LatLng(-94.6796875, 112.46875)),
  new Location("lithriken", new LatLng(-10.0390625, 121.90625)),
  new Location("lledrith_island", new LatLng(-48.890625, 52.84375)),
  ...
  new Location("minotaurs_rest", new LatLng(-52.578125, 47.3671875)),
  ...
  new Location("onyx_crest", new LatLng(-90.65625, 93.640625)),
  new Location("pandemoniom", new LatLng(-58.96875, 98.1796875)),
  new Location("pandemoniom_bank", new LatLng(-57.3671875, 97.3984375)),
  ...
  new Location("port_roberts_markets", new LatLng(-43.8125, 42.4453125)),
  new Location("port_roberts_sailor_mark", new LatLng(-43.234375, 44.1640625)),
  ...
  new Location("raindbows_end", new LatLng(-91.71875, 64.546875)),
  ...
  new Location("shimmering_atoll", new LatLng(-67.3125, 29.5078125)),
  new Location("shipyard", new LatLng(-70.7421875, 51.9765625)),
  ...
  new Location("summer_shore", new LatLng(-84.453125, 103.796875)),
  new Location("sunbleak_island", new LatLng(-88.4140625, 59.453125)),
  ...
  new Location("tear_of_the_soul", new LatLng(-68.2109375, 64.5234375)),
  new Location("tempoross_cove", new LatLng(-64.5859375, 96.3671875)),
  ...
  new Location("troubled_tortugans", new LatLng(-75.875, 94)),
  ...
  new Location("vatrachos_island", new LatLng(-58.3359375, 43.53125)),
  ...
  new Location("weissmere", new LatLng(-10.6171875, 85.7578125)),
  ...
  new Location("wintumber_island", new LatLng(-75.765625, 52)),
  ...
  new Location("ynysdail", new LatLng(-35.1484375, 59.203125)),
];
